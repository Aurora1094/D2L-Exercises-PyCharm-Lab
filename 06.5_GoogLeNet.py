...
class Inception(nn.Module):
    def __init__(self, in_channels, c1, c2, c3, c4, **kwargs):
        ...
        # 路径 2：1x1 卷积层后接 3x3 卷积层
        self.p2_1 = nn.Conv2d(in_channels, c2[0], kernel_size=1)
        self.p2_2 = nn.Conv2d(c2[0], c2[1], kernel_size=3, padding=1)
        # 路径 3：1x1 卷积层后接 5x5 卷积层
        self.p3_1 = nn.Conv2d(in_channels, c3[0], kernel_size=1)
        self.p3_2 = nn.Conv2d(c3[0], c3[1], kernel_size=5, padding=2)
        # 路径 4：3x3 最大池化层后接 1x1 卷积层
...
# 五个stage
# Stage 1 & 2: 基础卷积和池化（类似 AlexNet/VGG 的开头）
...
# Stage 3: 开始使用 Inception 块
b3 = nn.Sequential(Inception(192, 64, (96, 128), (16, 32), 32),
                   Inception(256, 128, (128, 192), (32, 96), 64),
                   nn.MaxPool2d(kernel_size=3, stride=2, padding=1))

# Stage 4: 更多的 Inception 块
...
# loss 0.247, train acc 0.905, test acc 0.891
# 2033.1 examples/sec on cuda:0